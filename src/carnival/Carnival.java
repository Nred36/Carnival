...
public class Carnival {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Balloon Dart Toss gave away " + balloonDartToss.prizesAwarded());
        System.out.println("Ring Toss gave away " + ringToss.prizesAwarded());
        System.out.println("Break a Plate gave away " + breakAPlate.prizesAwarded());
    }
}
